...
RUN curl "https://install.meteor.com/?release=1.8.0.2" | /bin/sh
...
RUN meteor npm install --global chimpy@TheBrainFamily/chimpy#d859c610d247c4199945b280b0f3a14c076153c7
